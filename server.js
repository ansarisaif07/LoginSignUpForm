...
const app = express();
const port = process.env.PORT || 8000;//port so we can host our website globaly else on host 3000
...
const uri = "mongodb+srv://7123saif:7123Ansari@cluster0.gig43rw.mongodb.net/?retryWrites=true&w=majority";
